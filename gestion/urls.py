...
urlpatterns = [
    ...
    path('autores/<int:pk>/eliminar-generic/', views.EliminarAutorView.as_view(), name='eliminar_autor_generic'),
    ...
    path('libros/<int:pk>/eliminar-generic/', views.EliminarLibroView.as_view(), name='eliminar_libro_generic'),
]
